  ...
  return (
    ...
    >
      <div className="flex flex-col">
        <div className="text-body-2 text-brand-20 max-sm:text-4">== CONFIDENTIAL: MEV INCIDENT REPORT ==</div>
        <div className="flex flex-row flex-wrap gap-3 text-body-2 text-brand-30">
