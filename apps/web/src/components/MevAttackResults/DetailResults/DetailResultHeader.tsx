...
export default function DetailResultHeader(
  { address, processedTime, isSignedWithTwitter }: DetailResultHeaderProps
) {
  return (
    <div className={cn(
      ...
      <div className="flex flex-col">
        <div className="text-body-2 text-brand-20 max-sm:text-[16px]">
          == CONFIDENTIAL: MEV INCIDENT REPORT ==
        </div>
