...
const buttonStyle = cva("button", {
  variants: {
    intent: {
      "primary-light": cn(
        "text-lg leading-6 bg-brand-10 text-brand-70",
        "px-[12px] py-[5px]",
      ...
      "primary-dark": cn(
        "text-lg leading-6 bg-brand-70 text-brand-10",
        "px-[12px] py-[5px]",
      ...
      secondary: cn(
        "text-lg leading-6 underline bg-brand-50 text-brand-20",
        "px-[12px] py-[5px]",
      ...
      tertiary: cn(
        "text-lg leading-6 underline text-brand-30",
